            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Card className="shadow-card border">
                ...
                <CardContent className="space-y-3 pt-2 text-sm">
                  ...
                  <div className="flex justify-between border-b pb-2"><span className="text-muted-foreground">Phone</span><span className="font-medium font-mono">{rc.owner?.phone || "—"}</span></div>
                  <div className="flex justify-between border-b pb-2"><span className="text-muted-foreground">Email</span><span className="font-medium font-mono">{rc.owner?.email || "—"}</span></div>
                  ...
                  <div className="flex justify-between border-b pb-2"><span className="text-muted-foreground">Address</span><span className="font-medium">{rc.owner?.address || "—"}</span></div>
